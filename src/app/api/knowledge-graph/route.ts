...
// ─────────────────────────────────────────────
// ✅ 你要的 46 个目标岗位 + 二级分类（固定在这里，保证稳定）
// ─────────────────────────────────────────────
const NEW_JOBS = [
  'Java开发','Python开发','C/C++开发','前端开发','后端开发','全栈开发',
  'Android开发','iOS开发','嵌入式开发','算法工程师','AI/机器学习',
  '大数据开发','运维工程师','信息安全','网络工程师','硬件工程师',
  '测试工程师','实施工程师','技术支持工程师','产品经理','UI/UX设计师',
  '平面设计师','视觉设计师','数据分析师','BI工程师','商业分析师',
  '运营专员','市场专员','品牌专员','新媒体运营','内容运营','社区运营',
  '电商运营','销售','商务拓展','客户经理','大客户销售','广告销售',
  'HR','招聘专员','财务','会计','法务','行政','供应链','项目经理'
];

// 二级分类目录
const CLASSIFIED_JOBS = [
  {
    category: "技术开发",
    jobs: [
      "Java开发","Python开发","C/C++开发","前端开发","后端开发","全栈开发",
      "Android开发","iOS开发","嵌入式开发","算法工程师","AI/机器学习",
      "大数据开发","运维工程师","信息安全","网络工程师","硬件工程师","测试工程师"
    ]
  },
  {
    category: "产品运营",
    jobs: [
      "产品经理","UI/UX设计师","平面设计师","视觉设计师","数据分析师",
      "BI工程师","商业分析师","运营专员","市场专员","品牌专员",
      "新媒体运营","内容运营","社区运营","电商运营"
    ]
  },
  {
    category: "市场销售",
    jobs: ["销售","商务拓展","客户经理","大客户销售","广告销售"]
  },
  {
    category: "职能管理",
...
export async function GET(req: NextRequest) {
  ...
  // ✅ 合并真实数据和新岗位，去重后得到56个岗位
  const realJobs = Object.keys(lp.lateral_paths);
  const allJobs = [...new Set([...realJobs, ...NEW_JOBS])];
  ...
  if (listOnly) {
    return NextResponse.json({
      ...
      classifiedJobs: CLASSIFIED_JOBS,
      meta: vp.meta,
      latMeta: lp.meta,
    });
  }
