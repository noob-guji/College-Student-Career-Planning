...
const STATIC_DATA: SearchResult[] = [
  // 功能入口
  { type:'功能', title:'岗位图谱',      desc:'交互式晋升/转岗路径可视化',  href:'/job-portrait' },
  ...
  // 常见岗位
  { type:'岗位', title:'前端开发工程师', desc:'前端开发 · 研发线', href:'/job-portrait' },
  { type:'岗位', title:'Java开发工程师', desc:'后端开发 · 研发线', href:'/job-portrait' },
  { type:'岗位', title:'产品经理',       desc:'产品线 · 高影响力', href:'/job-portrait' },
  { type:'岗位', title:'数据分析师',     desc:'数据线 · 数据驱动', href:'/job-portrait' },
