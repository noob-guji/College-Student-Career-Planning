...
import JobProfileCard from '@/app/components/JobProfileCard';
import JobKnowledgeGraph from '@/app/components/JobKnowledgeGraph';
import { ArrowLeftRight, ArrowUpDown, Briefcase } from 'lucide-react';
import { jobsData, jobList } from '@/app/data/jobsData';
        ...
        <div className="space-y-6 max-w-[1600px] w-full mx-auto h-[max(100%,_700px)] flex flex-col px-4 sm:px-6 lg:px-8 pb-6">
            <div className="flex justify-between items-center shrink-0">
                <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1">深度解析岗位能力模型与发展路径</p>
                </div>
                        ...
                        {jobList.map((job) => (
                            ...
                            >
                                <div className={`p-1.5 rounded-md ${
                                    selectedJob === job ? 'bg-amber-100 text-amber-600' : 'bg-slate-100 text-slate-400'
                                }`}>
